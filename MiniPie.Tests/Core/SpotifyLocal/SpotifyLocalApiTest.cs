...
namespace MiniPie.Tests.Core.SpotifyLocal
{
    public class SpotifyLocalApiTest: IDisposable
    {
        ...
        {
            _fakeResponseHandler.AddFakeResponse(new Uri("http://minipie.spotilocal.com:4381/remote/play.json?uri=&oauth=&csrf="), new HttpResponseMessage
            {
        ...
        {
            _fakeResponseHandler.AddFakeResponse(new Uri("http://minipie.spotilocal.com:4381/remote/pause.json?pause=true&oauth=&csrf="), new HttpResponseMessage
            {
                Content = new StringContent(ValidStatus)
            });
        ...
        {
            _fakeResponseHandler.AddFakeResponse(new Uri("http://minipie.spotilocal.com:4381/remote/pause.json?pause=false&oauth=&csrf="), new HttpResponseMessage
            {
                Content = new StringContent(ValidStatus)
            });
        ...
        public async Task TestQueue()
        {
            ...
            _fakeResponseHandler.AddFakeResponse(new Uri("http://minipie.spotilocal.com:4381/remote/play.json?uri=123%3faction%3dqueue&oauth=&csrf="), new HttpResponseMessage
            {
                Content = new StringContent(ValidStatus)
            });
        ...
        {
            _fakeResponseHandler.AddFakeResponse(new Uri("http://minipie.spotilocal.com:4381/simplecsrf/token.json"),
